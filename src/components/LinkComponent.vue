<template>
    ...
    <div v-show ="!isAboutPage" class="container mx-auto w-max bg-gray-200 dark:bg-gray-600 flex flex-col gap-2 fixed top-1/2 right-0 float-right shadow-md shadow-gray-600/50 border dark:border-none p-3">
