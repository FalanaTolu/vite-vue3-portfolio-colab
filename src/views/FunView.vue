<template>
  <div class="container h-full w-full flex flex-col justify-center items-center mx-auto p-8 m-10 text-gray-500">
    ...
    <div class="flex flex-col md:flex-row justify-center items-center mt-10 gap-2  xl:w-3/4">
